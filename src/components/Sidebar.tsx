...
import { Settings, Plus, LayoutGrid, Tag, ChevronDown, ChevronRight, Edit2, Trash2, Menu } from "lucide-react";
...
const Sidebar = () => {
  ...
  const SidebarContent = () => (
    <div className="flex-1 overflow-y-auto p-4">
      <Button variant="outline" className="w-full justify-start mb-4" onClick={() => {
        navigate("/");
